...
if (!class_exists('LWMiscCallback')) :
	
class LWMiscCallback extends LWCallbackBase {
	public $settings;
	public $bvinfo;
	public $siteinfo;
	public $account;
	...
	public function __construct($callback_handler) {
		...
		$this->bvinfo = new LWInfo($callback_handler->settings);
		$this->bvapi = new LWWPAPI($callback_handler->settings);
	}
