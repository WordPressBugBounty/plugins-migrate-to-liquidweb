...
if (!class_exists('LWInfoCallback')) :

class LWInfoCallback extends LWCallbackBase {
	public $db;
	public $settings;
	public $siteinfo;
	public $bvinfo;
	...
	public function __construct($callback_handler) {
		...
		$this->bvapi = new LWWPAPI($this->settings);
	}
	...
	public function getSystemInfo() {
		$sys_info = array(
			'host' => LWHelper::getRawParam('SERVER', 'HTTP_HOST'),
			'phpversion' => phpversion(),
			'AF_INET6' => defined('AF_INET6')
		);
		if (array_key_exists('SERVER_ADDR', $_SERVER)) {
			$sys_info['serverip'] = LWHelper::getRawParam('SERVER', 'SERVER_ADDR');
		}
	...
	public function getWpInfo() {
		...
		$wp_info = array(
			...
			'abspath' => ABSPATH,
			'bvpluginpath' => defined('LWBASEPATH') ? LWBASEPATH : null,
	...
	public function getHostInfo() {
		...
		if (isset($_SERVER['SERVER_ADDR']) && function_exists('gethostbyaddr')) {
			$host_info['HOST_FROM_IP'] = gethostbyaddr(LWHelper::getRawParam('SERVER', 'SERVER_ADDR'));
		}
	...
	public function serverConfig() {
		return array(
			'software' => LWHelper::getRawParam('SERVER', 'SERVER_SOFTWARE'),
