...
if (!class_exists('LWCallbackHandler')) :

	class LWCallbackHandler {
		public $db;
		public $settings;
		public $siteinfo;
		public $request;
		...
		public function execute($resp = array()) {
			...
			$resp = array(
				...
				"api_pubkey" => substr(LWAccount::getApiPublicKey($this->settings), 0, 8)
			);
